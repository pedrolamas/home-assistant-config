class VerticalStackInCard extends HTMLElement {
    ...
    setConfig(config) {
        ...
        if (config.title) {
            ...
            title.style = "font-family: var(--ha-card-header-font-family, inherit); color: var(--ha-card-header-color, --primary-text-color); font-size: var(--ha-card-header-font-size, 24px); letter-spacing: -0.012em; line-height: 32px; display: block; padding: 24px 16px 16px";
